...
var statz = angular.module('statz', []);

statz.directive('sz', function() {
	return {
		restrict: 'E',
		scope: true,
...
statz.controller('StatzController', ['$rootScope', '$scope', function($rootScope, $scope) {
...
statz.controller('StatzFilterController', ['$rootScope', '$scope', function($rootScope, $scope) {
	var self = this;
...
statz.controller('StatzRankingController', ['$rootScope', '$scope', function($rootScope, $scope) {
	var self = this;
...
statz.controller('StatzPaisController', ['$rootScope', '$scope', function($rootScope, $scope) {
	var self = this;
